# Outline Detailed: Laporan Bidang Dana dan Usaha — MUNAS 2026

*Detailed-style: Versi lebih lengkap dengan konten detail di setiap slide. Cocok sebagai dokumen pendukung atau presentasi yang bisa berdiri sendiri tanpa pembicara.*
...
24-25 April 2026 | Hotel Royal Orchid, Batu Malang

*Visual:* Logo Al Khidmah + branding MUNAS, nuansa hijau-emas

---

## SLIDE 2 — In Memoriam [Wajib]
**In Memoriam: Pak Yaumi Azhar (Almarhum)**
Ketua Bidang Dana dan Usaha
Pengurus Pusat Jama'ah Al Khidmah
Masa Khidmat 2022-2026

Laporan ini disampaikan atas nama almarhum, diwakilkan oleh Ketua Umum PP Al Khidmah.

*Visual:* Foto almarhum (jika ada) atau ilustrasi nuansa damai dengan ornamen Islami
...
*"Di sini kita ibarat seekor burung yang ingin terbang tinggi, kita kembangkan dan gerakkan kedua sayap ini..."*
...
*Visual:* Ilustrasi burung terbang dengan dua sayap berlabel, ornamen Islami

---

## SLIDE 4 — Dasar AD/ART [Wajib]
**Landasan Organisasi**
...
## SLIDE 6 — Konteks [Wajib]
**Mengapa Bidang Dana & Usaha Penting?**
...
- Diperlukan: Sumber pemasukan yang berkelanjutan
- Periode 2022-2026: Pendekatan trial and error sebagai langkah awal membangun sistem

---

## SLIDE 7 — Overview 3 Pilar [Wajib]
**3 Pilar Kinerja Bidang Dana dan Usaha**

| Pilar | Program |
|-------|---------|
| 🏢 Kemandirian Kewirausahaan | PT DBL (Peternakan Ayam), Sarung Gloyor |
...
## SLIDE 8 — PT DBL: Pendirian [Wajib]
...
## SLIDE 9 — PT DBL: Kontribusi [Wajib]
...
## SLIDE 10 — Sarung Gloyor: Launching [Wajib]
**Sarung Tenun Gloyor Ndalem Al Khidmah**
🎉 GRAND LAUNCHING: MUNAS 24-25 April 2026
...
*Visual:* Foto motif sarung dari `sources/references/images/`

---

## SLIDE 11 — Sarung Gloyor: Skema Bisnis [Wajib]
...
## SLIDE 12 — Sarung Gloyor: 3 Motif [Wajib]
...
## SLIDE 17 — Transisi [Wajib]
**Fondasi 2022-2026 → Akselerasi 2026-2029**

*"MEMBANGUN EKOSISTEM MANDIRI AL KHIDMAH"*

Ke depan, pengembangan kewirausahaan diharapkan:
- Dikelola secara terstruktur, profesional, berkelanjutan
- Melibatkan SDM jama'ah yang kompeten
- Memberikan manfaat lebih luas bagi jama'ah dan organisasi

---

## SLIDE 18 — Forum Pengusaha [Wajib]
**Pembentukan Forum Pengusaha Nasional Al Khidmah**

One Stop Solution bagi pengusaha jama'ah:
...
## SLIDE 19 — Akselerasi Kemitraan [Wajib]
**Akselerasi Kemitraan Kewirausahaan**

- Membuka kerjasama bagi pelaku usaha
- Skema bagi hasil — model kerjasama dapat didiskusikan
- Usulan program untuk 2026-2029:
  - Ekspansi PT DBL
...
## SLIDE 20 — Ekspansi PT DBL [Wajib]
...
## SLIDE 21 — Optimalisasi Sarung [Wajib]
...
## SLIDE 22 — Budidaya Lele: Mengapa? [Wajib]
...
*Visual:* Foto kolam lele (`sources/references/images/lele-kolam-padat.jpg`)

---

## SLIDE 23 — Budidaya Lele: Target [Wajib]
**Target & Implementasi**

**Target:** Setiap PW/PD/PC memiliki minimal 3-10 kolam aktif → cash flow rutin tiap 3 bulan

**Spesifikasi Kolam:**
- Kolam terpal/kolon beton, diameter 5 meter
- Tebar 10.000 ekor per kolam
- Hasil panen: **1 ton lele per kolam**

*Visual:* Foto pemberian pakan (`sources/references/images/lele-pemberian-pakan.jpg`)

---

## SLIDE 24 — Budidaya Lele: Tahapan [Wajib]
...
## SLIDE 25 — Khidmah Connect: Overview [Wajib]
...
## SLIDE 26 — Khidmah Connect: Fitur [Wajib]
**4 Fitur Utama Khidmah Connect**

| Fitur | Fungsi |
|-------|--------|
| ℹ️ Sumber Informasi Majlis | Informasi majlis di seluruh dunia |
| 💳 PPOB | Transaksi harian (pulsa, PLN, PDAM, dll) |
| 🛒 Marketplace/Store | Perdagangan produk jama'ah |
| ❤️ Donasi Digital | Campaign terarah |

*Visual:* Ilustrasi 4 fitur terintegrasi + screenshot PPOB

---

## SLIDE 27 — Khidmah Connect: Investasi [Wajib]
...
2. 🤝 **Sinergi Antar Lembaga**
   Koordinasi agar tidak terjadi tumpang tindih program (kasus Jimpitan vs UPZ)
...
## SLIDE 30 — Ajakan [Wajib]
**Mari Bersama Membangun Ekosistem Mandiri Al Khidmah**

Kolaborasi seluruh PW/PD/PC dan jama'ah:

- 🏢 **Ikut serta dalam usaha** — PT DBL, Sarung Gloyor, Budidaya Lele
- 💻 **Gunakan Khidmah Connect** — transaksi harian yang memberi manfaat
- 🤝 **Jalin kemitraan & CSR** — sinergi untuk kemaslahatan
- 🤲 **Doakan keberkahan** — usaha kita bersama

---

## SLIDE 31 — Penutup [Wajib]
...
Semoga apa yang telah diperjuangkan menjadi amal jariyah yang berkelanjutan. Aamiin.

*Visual:* Nuansa damai, spiritual (`sources/references/images/cover-doa.jpg` sebagai referensi visual)

---

**Total: 31 slide (semua wajib)**
**Estimasi durasi: ±30-35 menit (detailed style)**
